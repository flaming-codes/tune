...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "analytics-section-title_widget".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "analytics-events-total_widget".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "analytics-track-events_widget".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "analytics-top-pages_widget".
 */
