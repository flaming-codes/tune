...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  `)
  await db.run(
    sql`INSERT INTO \`__new_team_members\`("id", "name", "role", "description", "sort_order", "is_active", "updated_at", "created_at") SELECT "id", "name", "role", "description", "sort_order", "is_active", "updated_at", "created_at" FROM \`team_members\`;`,
  )
